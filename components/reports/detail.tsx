...
export default function ReportDetails({ report }: Props) {
  ...
  const mapReportType = (type: number): JSX.Element => {
    switch (type) {
      case 0:
        return <Badge className="bg-red-500 text-white">Tranh cãi</Badge>;
      case 1:
        return <Badge className="bg-yellow-500 text-white">Tai nạn</Badge>;
      case 2:
        return <Badge className="bg-purple-500 text-white">Báo phạt</Badge>;
      case 3:
        return <Badge className="bg-orange-500 text-white">Hư hỏng</Badge>;
      case 4:
        return <Badge className="bg-green-500 text-white">Bảo trì</Badge>;
      case 5:
        return <Badge className="bg-blue-500 text-white">Khác</Badge>;
      default:
                    ...
                    <CardContent className="grid gap-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {report.carDetail.manufacturerName}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                    ...
                    <CardContent className="grid gap-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3">
                          <Avatar>
                            <AvatarImage
                              src="/placeholder.svg?height=40&width=40"
                              alt={report.bookingDetail.driverName}
                            />
                            <AvatarFallback>
                              {report.bookingDetail.driverName.charAt(0)}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            <p className="font-medium">
                              {report.bookingDetail.driverName}
                            </p>
                        ...
                        <div className="flex items-center gap-3">
                          <Avatar>
                            <AvatarImage
                              src="/placeholder.svg?height=40&width=40"
                              alt={report.bookingDetail.ownerName}
                            />
                            <AvatarFallback>
                              {report.bookingDetail.ownerName.charAt(0)}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            <p className="font-medium">
                              {report.bookingDetail.ownerName}
                            </p>
                            <div className="flex items-center gap-1 text-sm text-muted-foreground">
                              <Phone className="h-3 w-3" />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-medium">
                            {formatDate(report.bookingDetail.startTime)}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground flex items-center gap-1">
                          ...
                          <p className="font-medium">
                            {formatDate(report.bookingDetail.endTime)}
                          </p>
                        </div>
                      </div>
                      <Separator />
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-medium">
                            {formatCurrency(report.bookingDetail.basePrice)}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">
                          ...
                          <p className="font-medium">
                            {formatCurrency(report.bookingDetail.totalAmount)}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                      ...
                      <CardContent className="grid gap-4">
                        <div className="flex items-center gap-3">
                          <Avatar>
                            ...
                            />
                            <AvatarFallback>
                              {report?.compensationDetail?.userName?.charAt(
                                0
                              ) ?? ""}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            <p className="font-medium">
                              {report?.compensationDetail?.userName ?? ""}
                            </p>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {report?.compensationDetail?.compensationReason ??
                              ""}
                          </p>
                        </div>
                        ...
                        {report?.compensationDetail?.paidAt && (
                          <div>
                            ...
                            <p className="font-medium">
                              {formatDate(report.compensationDetail.paidAt)}
                            </p>
                          </div>
                        )}
                      </CardContent>
                      ...
                      <CardContent className="grid gap-4">
                        <div className="flex items-center gap-3">
                          <Avatar>
                            ...
                            />
                            <AvatarFallback>
                              {report?.inspectionScheduleDetail?.technicianName?.charAt(
                                0
                              ) ?? ""}
                            </AvatarFallback>
                          </Avatar>
                          ...
                          0 && (
                            <div>
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                {report?.inspectionScheduleDetail?.photoUrls?.map(
                                  (imageUrl, index) => (
                                    <div
                                      key={index}
                                      className="relative aspect-video rounded-md overflow-hidden border"
